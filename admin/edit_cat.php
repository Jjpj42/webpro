...
<head>
    ...
    <title>Dashboard(Edit Product List Info)</title>
</head>
<body>
...
<div class="container">
    <div class="row">
        <div class="col-lg-3">
            <h4 class="my-4" style="margin-top:6.0rem!important;font-size:30px;">Edit Produce List Info</h4>
        ...
        <div class="col-lg-9">
            <div class="cat-header" style="text-align: center;">
                <h4 class="my-4" style="margin-top:6.0rem!important;">Edit Product List </h4>
            </div>
            <form action="assets/php/update_cat.php" method="post">
                <div class="container">
                    <div class="row">
                        ...
                        <?php
                            // LOAD CAT DATA
                            $ct = $_GET['ct'];
                            $sql = "select * from category where id_category ='$ct'";
                            $load = $con->query($sql);
                            if($rs = $load->fetch_assoc()):
                        ?>
                        <div class="mb-3 col-lg-4">
                            <input type="text" name="ct" value="<?php echo $rs['id_category'] ?>" readonly class="form-control">
                        </div>
                        <div class="mb-3 col-lg-4">
                            <input type="text" name="type_product" value="<?php echo $rs['type_product'] ?>" class="form-control">
                        </div>
                        <?php
                        endif;
                        ?>
