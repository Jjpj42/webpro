...
<div class="container">
    <div class="row">
        <div class="col-lg-3">
            <h4 class="my-4" style="margin-top:6.0rem!important;font-size:50px;">User</h4>
        ...
        <div class="col-lg-9">
            <div class="cat-header" style="text-align: center;">
                <h4 class="my-4" style="margin-top:6.0rem!important;">Add New User</h4>
            </div>
            <form action="assets/php/add_user.php" method="post" >
                <div class="container">
                    <div class="row">
                        ...
                        <div class="mb-3 col-lg-6">
                            <input type="text" name="phone_num" placeholder="Phone" required class="form-control">
                        </div>
                        <div class="mb-3 col-lg-6">
